...
void draw() {
	...
	for ( int i = 0; i < 8; i++ ) {
		for ( int j = 0; j < 8; j++ ) {
			...
			else                 fill( map(nota, 0, 12, 0, 256), 140 + 20 * octa, 240 );
...
/*
T: 17
B: G4, A4, A4, A4, A4, G4, G4, G4, 
   G4, E4, A4, A4, A4, A4, A4, A4, 
   E4, A4, A4, A4, G4, A4, A4, A4, 
   E4, G4, E4, E4, E4, G4, G4, E4, 
   G4, E4, G4, E4, E4, E4, G4, E4, 
   G4, E4, A4, A4, A4, G4, G4, E4, 
   E4, A4, A4, G4, E4, A4, A4, G4, 
   G4, G4, E4, E4, G4, A4, A4, A4
*/
